    ...
    <div class="flex items-center p-4 w-full max-w-xs text-gray-500 bg-white rounded-lg shadow dark:text-gray-400 dark:bg-gray-800" role="alert">
      <div class="inline-flex items-center justify-center flex-shrink-0 w-8 h-8 text-red-500 bg-red-100 rounded-lg dark:bg-red-800 dark:text-red-200">
        <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
          <path fill-rule="evenodd" d="M18 8a6 6 0 11-12 0 6 6 0 0112 0zm-6 2a1 1 0 000 2H6a1 1 0 000 2h6a1 1 0 000-2H8a1 1 0 000-2h6zm-.707-4.707a1 1 0 01.707.293l1 1a1 1 0 01-1.414 1.414L12 7.414l-.293.293a1 1 0 01-1.414-1.414l1-1a1 1 0 01.707-.293z" clip-rule="evenodd"></path>
        </svg>
