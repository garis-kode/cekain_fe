<template>
  ...
  <div>
    ...
    <div class="my-10">
      <h1 class="text-3xl font-bold mb-2 dark:text-white">Reset Password ?</h1>
      <p class="text-gray-400 text-md dark:text-gray-400">Setup your new password</p>
    </div>
    <form>
        <div class="my-6">
          <div class="mb-3">
          ...
          <div class="mb-3">
              <label for="password" class="block mb-2 text-sm font-semibold text-gray-900 dark:text-white">Repeat Password</label>
              <input type="password" id="password" class="bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="•••••••••" required />
          </div> 
        </div>
